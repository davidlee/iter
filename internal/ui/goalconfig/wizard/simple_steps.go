...
// AIDEV-NOTE: Step handler implementation pattern for goal flows
// Follow this pattern for elastic/informational goal step handlers:
...
// BasicInfoStepHandler handles basic goal information collection
...
func NewBasicInfoStepHandler(goalType models.GoalType) *BasicInfoStepHandler {
...
func (h *BasicInfoStepHandler) GetDescription() string {
	return "Enter the basic details for your goal"
}
...
// ScoringStepHandler handles scoring configuration for goals
...
func NewScoringStepHandler(goalType models.GoalType) *ScoringStepHandler {
...
func (h *ScoringStepHandler) GetDescription() string {
	...
	case models.SimpleGoal:
		return "Choose how this goal will be scored"
...
func NewConfirmationStepHandler(goalType models.GoalType) *ConfirmationStepHandler {
...
func (h *ConfirmationStepHandler) Render(state State) string {
	...
	if h.formComplete {
		if h.confirmed {
			return "✅ Goal Configuration Confirmed\n\nPress 'f' to finish and create the goal."
		}
...
func (h *ConfirmationStepHandler) GetDescription() string {
	return "Review and confirm your goal configuration"
}

// IsConfirmed returns whether the user confirmed goal creation
