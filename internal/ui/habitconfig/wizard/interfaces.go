// Package wizard provides bubbletea-based wizard components for habit configuration.
//
...
// - State interface: extend for additional wizard types beyond habit configuration
